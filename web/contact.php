...
<head>
    ...
    <section class="contact">
        ...
        <div class="row">
            ...
            <div class="row">
                <div class="col-md-7">
                <form class="form-a contactForm" action="sendVisits.php" method="post" role="form">
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-group">
                        <input name="houseNum" type="houseNum" class="form-control form-control-lg form-control-a" placeholder="House Number" data-rule="minlen:3" data-msg="Please enter at least 3 house number">
                        <div class="validation"></div>
                        </div>
                    </div>
