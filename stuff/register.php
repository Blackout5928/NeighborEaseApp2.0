...
<body>
                ...
                <div class="main-content-container container-fluid px-4">
                    ...
                    <div class="page-header row no-gutters py-4">
                        <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
                            <span class="text-uppercase page-subtitle">Create Account</span>
                            <h3 class="page-title">Home Owner Registration</h3>
                        </div>
                    </div>
                    <!-- End Page Header -->
                    <div class="row">
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-12 mb-4">
                                <div class="card card-small mb-4" style="padding: 30px; width: 1000px">
                                    <form id="registrationForm" action="register_process.php" method="post">
                                        <div class="mb-3">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <div class="btn-vid">
                                                        <button type="button" id="captureBtn" class="btn btn-success">Capture</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="mb-3">
                                            <label for="hnum" class="form-label"><b>Address</b></label>
                                            <input type="text" class="form-control" id="hnum" name="hnum" placeholder="House Number" required>
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            <label for="email" class="form-label"><b>Contact</b></label>
                                            <div class="row">
                                                <div class="col">
    ...
    <script>
        $(document).ready(function() {
          ...
          //button para sa qr code genearte
            generateQRBtn.addEventListener('click', () => {
                ...
                var qrCodeUrl = 'https://api.qrserver.com/v1/create-qr-code/?data=' + encodeURIComponent(qrContent) + '&size=200x200';
